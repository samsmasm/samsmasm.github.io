...
LEDE_PROMPT = """\
Write a single punchy sentence (20 words max) summarising this week's economics stories. Use short, vivid, slightly wry phrases — like a smart friend telling you what's in the news. No em dashes. Return only the sentence, nothing else.
